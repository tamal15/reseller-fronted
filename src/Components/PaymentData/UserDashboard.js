...
const NewUserDashboard = () => {
  ...
  useEffect(() => {
    const fetchTotalIncome = async () => {
      try {
        const response = await fetch(`https://server.exportmark.com/myincome/${user.email}`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchWithdrawalHistory = async () => {
      try {
        const response = await fetch(`https://server.exportmark.com/api/withdraw-history/${user.email}`);
        const data = await response.json();
        if (data) {
  ...
  const handlePullIncome = async () => {
    try {
      ...
      if (result.isConfirmed) {
        const response = await fetch(`https://server.exportmark.com/api/pull-income/${user.email}`, {
          method: 'PATCH',
          headers: {
  ...
  const handlePullIncomes = async () => {
    try {
      ...
      if (result.isConfirmed) {
        const response = await fetch(`https://server.exportmark.com/api/reference-pull-income/${user.email}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleClose = () => setOpen(false);
   ...
   const fetchBalanceData = async () => {
    ...
    try {
      const response = await fetch(`https://server.exportmark.com/payment-collection/${user.email}`);
      const data = await response.json();
  ...
  const handleWithdrawSubmit = async () => {
    ...
    try {
      const response = await fetch('https://server.exportmark.com/api/withdraw', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (response.ok) {
        ...
        const updatedHistoryResponse = await fetch(`https://server.exportmark.com/api/withdraw-history/${user.email}`);
