...
const PotteryProduct = () => {
    ...
    // useEffect(() => {
    //     fetch('https://server.exportmark.com/PotteryProducts')
    //         .then(res => res.json())
    ...
    // useEffect(()=>{
    //     fetch('https://server.exportmark.com/likes')
    //     .then(res=>res.json())
    //     .then(data=>{
    //       setValue(data)
    //       setQuestions(data)
                ...
                <Grid  container spacing={2} columns={{ xs: 4, sm: 8, md: 4 }}>
                  ...
                  <Grid item xs={2} sm={4} md={8} pl={2} my={3}>
                    ...
                    <h5 style={{fontWeight:"700"}}>Name : {single?.productName}</h5>
                      ...
                      {/* <ThumbUpIcon onClick={()=>{likepost(single?._id)}}></ThumbUpIcon> */}
