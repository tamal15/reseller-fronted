...
const EditPotterData = () => {
   const [user,setUser]=useState({})
   const {id}=useParams()
   useEffect(()=>{
    fetch(`https://evening-chamber-61046.herokuapp.com/potter/${id}`)
    .then(res=>res.json())
    ...
    const handleupdate=e=>{
        ...
        fetch(`https://evening-chamber-61046.herokuapp.com/updatePotter/${id}`, {
            method: "PUT",
