...
const Scheduleupdate = () => {
   ...
   useEffect(()=>{
    ...
    const handleupdate=e=>{
        ...
        fetch(`https://server.exportmark.com/updatesSchedules/${id}`, {
            method: "PUT",
    ...
    const handleName=e=>{
        // e.preventDefault()
        const updateSchedule=(e.target.value)
        const update={schedules:updateSchedule, ProductPrice:user.ProductPrice}
        setUser(update)
    }
    // const handlePrice=e=>{
    //     // e.preventDefault()
