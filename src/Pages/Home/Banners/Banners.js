...
<Paper className="keys first" sx={{}} elevation={5}>
             <Card className="keys first" sx={{  border: 0, boxShadow: 0  }}>
            
             
      <CardContent className="first"  sx={{}}>
       ...
       <Grid item xs={4} sm={4} md={6}>
       <h5 style={{color:"white",fontWeight:"700"}}>We Provide Product Dhatob Shilpo</h5>
       </Grid>
       </Grid>
...
{/* 2nd step  */}
<Grid item xs={4} sm={4} md={4}>
<Paper className="keys second" sx={{}} elevation={5}>
             <Card className="keys second" sx={{  border: 0, boxShadow: 0  }}>
      ...
      <CardContent className=""  sx={{}}>
       ...
       <Grid item xs={4} sm={4} md={6}>
       <h5 style={{color:"white", fontWeight:"700"}}>We Provide Product putul Shilpo</h5>
       </Grid>
       </Grid>
        </Typography>
...
<Paper className="keys" sx={{}} elevation={5}>
      ...
      <CardContent className="third"  sx={{}}>
       ...
       <Grid item xs={4} sm={4} md={6}>
       <h5 style={{color:"white", fontWeight:"700"}}>We Provide Product Pitol Industry</h5>
       </Grid>
       </Grid>
        </Typography>
...
<Paper className="keys dell" sx={{}} elevation={5}>
      ...
      <CardContent className="dell"  sx={{}}>
       ...
       <Grid item xs={4} sm={4} md={6}>
       <h5 style={{color:"white",fontWeight:"700"}}>We Provide Product Jamdani Shree</h5>
       </Grid>
       </Grid>
...
<Paper className="keys dell" sx={{}} elevation={5}>
      ...
      <CardContent className="dell"  sx={{}}>
       ...
       <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 2, sm: 8, md: 12 }}>
       <Grid item xs={4} sm={4} md={6}>
          {/* <img height="100" width="170" style={{padding:"0"}} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkE7Nh2C_C2_PgiwKbAphvAG72P6hrZa5qXsCZK8EY2WjHUdR_-KPLmTIs1QqhTtLwxgU&usqp=CAU'></img> */}
